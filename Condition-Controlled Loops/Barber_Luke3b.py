...
if draw == 'yes':
    if invalid_tri == False:
        canvwid = (side1+side2+side3)
        canvhei = (side1+side2+side3)
        import turtle
        window = turtle.Screen()
        window.setup(width = canvwid, height = canvhei)
        if shape == 'equi':
            turtle.color('green')
        elif shape == 'iso':
            turtle.color('blue')
            ...
            turtle.color('red')
        turtle.penup()
        turtle.goto(pt1x,pt1y)
        turtle.pendown()
        turtle.goto(pt2x,pt2y)
        turtle.goto(pt3x,pt3y)
        turtle.goto(pt1x,pt1y)
